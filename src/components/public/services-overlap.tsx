...
export function ServicesOverlapSection() {
  return (
    <section
      id="servicios"
      className="relative bg-white pb-20 text-zinc-900 sm:pb-24 lg:pb-32"
    >
      ...
      <div className="mx-auto mt-20 w-full max-w-7xl px-6 sm:mt-24 lg:mt-28 lg:px-10">
        <div className="max-w-3xl">
          <span className="text-[12px] font-bold uppercase tracking-[0.22em] text-rust-500">
            Características principales
          </span>
          <h2 className="mt-4 font-display text-[44px] leading-[0.95] tracking-[0.01em] text-zinc-950 sm:text-[56px] lg:text-[64px]">
            Diseñado para quien
            <br />
          ...
          <p className="mt-6 max-w-2xl text-[15px] leading-7 text-zinc-600 sm:text-[16px] sm:leading-8">
            ...
            forma real en que se trabaja en un taller: manos llenas de grasa,
            prisa de mostrador y vehículos esperando. Cada pantalla resuelve
            una decisión, no decora el escritorio.
          </p>
        </div>
...
function Feature({
  ...
  return (
    <div className="group/feature">
      <div className="grid h-12 w-12 place-items-center bg-safety-500 text-zinc-950 transition-colors duration-200 group-hover/feature:bg-rust-500 group-hover/feature:text-white">
        {icon}
      </div>
      <h3 className="mt-5 font-display text-[22px] leading-tight tracking-[0.02em] text-zinc-950">
        {title}
      </h3>
