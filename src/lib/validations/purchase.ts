...
const itemSchema = z.object({
  ...
  // Tasa IVA efectiva por línea (0 = exento, 12 / 15 = gravado).
  // Permite que una factura mezcle productos exentos y gravados a distintas tasas.
  item_tax_rate: z.number().min(0).max(100).default(15),
