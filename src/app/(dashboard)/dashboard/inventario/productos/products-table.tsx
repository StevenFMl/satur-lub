                ...
                paginated.map((r) => (
                  ...
                  >
                    ...
                    <Td className="hidden sm:table-cell text-right">
                      {(() => {
                        const rate = r.has_tax && r.tax_rate != null && r.tax_rate > 0 ? r.tax_rate : 0;
                        const withIva = (net: number) => rate > 0 ? net * (1 + rate / 100) : null;
                        const cpp = Number(r.average_cost ?? 0);
                        const last = r.last_purchase_cost != null ? Number(r.last_purchase_cost) : null;
                        return (
