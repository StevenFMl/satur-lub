...
export const metadata: Metadata = {
  ...
  description:
    "Plataforma operativa para lubricentros, talleres mecánicos y ferreterías automotrices. Órdenes de servicio, vehículos, inventario, caja y facturación en un solo panel.",
};
